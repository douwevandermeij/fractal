...
deps:  ## Install dependencies
	...
	python -m pip install black coverage django fastapi flake8 flit isort mccabe mypy pylint pytest pytest-cov pytest-asyncio pytest-lazy-fixture requests sqlalchemy tox tox-gh-actions
